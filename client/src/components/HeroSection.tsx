...
import { FiSearch, FiCode, FiUsers, FiBarChart2, FiPlay } from "react-icons/fi";

interface HeroSectionProps {
  scrollToDemo: () => void;
}

const HeroSection: React.FC<HeroSectionProps> = ({ scrollToDemo }) => {
  return (
    <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-blue-50 to-indigo-50">
      {/* Background elements */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            Create targeted technical interviews with AI-generated questions, evaluation criteria, and candidate insights—all in one platform.
          </motion.p>
          ...
          >
            ...
            <button className="px-8 py-4 bg-white text-gray-800 font-medium rounded-full border border-gray-200 hover:bg-gray-50 transition-all duration-300 flex items-center gap-2">
